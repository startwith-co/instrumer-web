...
const RegisterForm = () => {
  ...
  return (
    <div className="w-full max-w-screen-md rounded-lg bg-white shadow-lg">
      {/* 탭 헤더 */}
      <div className="flex">
        <button
          type="button"
          ...
          className={cn(
            'flex-1 rounded-tl-lg py-4 text-center text-sm font-semibold leading-none tracking-[-0.02em] transition-colors',
            activeTab === 'consumer'
        ...
        <button
          ...
          className={cn(
            'flex-1 rounded-tr-lg py-4 text-center text-sm font-semibold leading-none tracking-[-0.02em] transition-colors',
            activeTab === 'vendor'
              ? 'bg-white text-primary'
